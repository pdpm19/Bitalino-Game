...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load(os.path.join(gamePath, 'assets' ,'img', 'car.png'))
        ...
        # Background
        self.bgImg = pygame.image.load(os.path.join(gamePath, 'assets' ,'img', 'back_ground.jpg'))
    ...
    def generate_enemy(self):
        ...
        enemy_car = 'enemy_car_' + str(i) + '.png'
        print('NOME: ' + enemy_car)
        self.enemy_car = pygame.image.load(os.path.join(gamePath, 'assets' ,'img', enemy_car))
        # cars should be 49x100
        self.enemy_car = pygame.transform.scale(self.enemy_car, (49, 100))
