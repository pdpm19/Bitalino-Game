...
# Faz init de todos os módulos do PyGame
pygame.init()

# Variáveis & Definições básicas
display_width = 800
display_height = 600
...
crash_sound = pygame.mixer.music.load(os.path.join(assets_path, "sounds", "crash.wav"))
car_width = 55
...
gameIcon = pygame.image.load(os.path.join(assets_path, "img", "carIcon.png"))

backgroundImage = pygame.image.load(os.path.join(assets_path, "img", "background.png"))
...
#pygame.time.set_timer(print_message, 300)
